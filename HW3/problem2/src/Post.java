...
class Post {
    ...
    public int checkFrequency(String keyword) {
        int frequency = 0;
        String[] contentChecker = content.split("\\s+");
        String[] titleChecker = title.split("\\s");

        for (String string: contentChecker) {
            if (string.equals(keyword)) {
                frequency++;
            }
        }
        for (String string: titleChecker) {
            if (string.equals(keyword)) {
                frequency++;
            }
        }
