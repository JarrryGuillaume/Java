...
public class Test {
    ...
    static void subproblem2() {
        ...
        System.out.println(buyer2ExpectedPrice + " " + seller2ExpectedPrice);
        System.out.println(buyer3ExpectedPrice + " " + seller3ExpectedPrice);
        System.out.println(buyer4ExpectedPrice + " " + seller4ExpectedPrice);
